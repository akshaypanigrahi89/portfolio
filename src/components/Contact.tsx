            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  className="w-full px-4 py-3.5 rounded-lg bg-background border border-border text-sm focus:outline-none focus:border-primary/50 transition-colors"
            ...
            <div>
              <label htmlFor="message" className="block text-xs text-muted-foreground mb-1.5">
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3.5 rounded-lg bg-background border border-border text-sm focus:outline-none focus:border-primary/50 transition-colors resize-vertical min-h-[140px]"
